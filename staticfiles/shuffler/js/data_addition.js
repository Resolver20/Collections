...
export function Adding_in_columns(src, image, name, index,slide_data,width,height) {
    ...
    div_1.innerHTML = "<a target='_blank'  href=" + String(src) + "><img src=" + String(image) + " alt='" + String(name) + "' data-width='"+String(width)+"' data-height='"+String(height)+"'> </a>";
...
export var column_height_measure = { "column_1": 20, "column_2": 20, "column_3": 20, "column_4": 20 };
